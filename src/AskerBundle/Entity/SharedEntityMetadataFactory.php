...
namespace AskerBundle\Entity;

use AskerBundle\Entity\DomainKnowledge\Metadata as KnowledgeMetadata;
use AskerBundle\Entity\ExerciseModel\Metadata as ModelMetadata;
use AskerBundle\Entity\ExerciseResource\Metadata as ResourceMetadata;
