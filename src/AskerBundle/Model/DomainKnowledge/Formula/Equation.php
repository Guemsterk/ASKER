...
class Equation extends Expression
{
     ...
     * Set leftExpression
     *
     * @param \AskerBundle\Model\DomainKnowledge\Formula\Expression $leftExpression
     */
     ...
     * Set rightExpression
     *
     * @param \AskerBundle\Model\DomainKnowledge\Formula\Expression $rightExpression
     */
    ...
    public function evaluate(array $parameters = array())
    {
        if (get_class($this->leftExpression) !==
            'AskerBundle\Model\DomainKnowledge\Formula\Variable'
        ) {
