...
class Variable extends Unknown
{
     ...
     * @Serializer\Type("AskerBundle\Model\Resources\DomainKnowledge\Formula\Interval")
     * @Serializer\Groups({"details", "knowledge_storage", "resource_storage", "exercise_model_storage"})
     */
    private $interval;
     ...
     * Set interval
     *
     * @param \AskerBundle\Model\Resources\DomainKnowledge\Formula\Interval $interval
     */
     ...
     * Get interval
     *
     * @return \AskerBundle\Model\Resources\DomainKnowledge\Formula\Interval
     */
