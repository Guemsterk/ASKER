...
class ExerciseResource
{
    ...
    /**
     * @const MULTIPLE_CHOICE_CLASS = 'AskerBundle\Model\Resources\Exercise\MultipleChoice\Exercise'
     */
    const MULTIPLE_CHOICE_CLASS = 'AskerBundle\Model\Resources\Exercise\MultipleChoice\Exercise';

    /**
     * @const GROUP_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\GroupItems\Exercise'
     */
    const GROUP_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\GroupItems\Exercise';
     ...
     * @const GROUP_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\GroupItems\Exercise'
     */
    const ORDER_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\OrderItems\Exercise';

    /**
     * @const PAIR_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\PairItems\Exercise'
     */
    const PAIR_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\PairItems\Exercise';

    /**
     * @const OPEN_ENDED_QUESTION_CLASS = 'AskerBundle\Model\Resources\Exercise\OpenEndedQuestion\Exercise'
     */
    const OPEN_ENDED_QUESTION_CLASS = 'AskerBundle\Model\Resources\Exercise\OpenEndedQuestion\Exercise';
     ...
     * @Serializer\Type("AskerBundle\Model\Resources\Exercise\Common\CommonExercise")
    ...
    /**
     * @var array
     * @Serializer\Type("array<AskerBundle\Model\Resources\AttemptResource>")
     ...
     * Set content
     *
     * @param \AskerBundle\Model\Resources\Exercise\Common\CommonExercise $content
     */
     ...
     * Get content
     *
     * @return \AskerBundle\Model\Resources\Exercise\Common\CommonExercise
     */
