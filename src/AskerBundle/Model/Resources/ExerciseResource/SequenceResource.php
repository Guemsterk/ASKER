...
class SequenceResource extends CommonResource
{
    ...
    /**
     * @var SequenceBlock
     * @Serializer\Type("AskerBundle\Model\Resources\ExerciseResource\Sequence\SequenceBlock")
     * @Serializer\Groups({"details", "resource_storage", "resource_storage"})
     * @Assert\NotBlank(groups={"create"})
     * @Assert\Valid
     */
     ...
     * Set mainBlock
     *
     * @param \AskerBundle\Model\Resources\ExerciseResource\Sequence\SequenceBlock $mainBlock
     */
     ...
     * Get mainBlock
     *
     * @return \AskerBundle\Model\Resources\ExerciseResource\Sequence\SequenceBlock
     */
