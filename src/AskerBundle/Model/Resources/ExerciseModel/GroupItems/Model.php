...
namespace AskerBundle\Model\Resources\ExerciseModel\GroupItems;
...
class Model extends CommonModel
{
     ...
     * @Serializer\Type("array<AskerBundle\Model\Resources\ExerciseModel\GroupItems\ObjectBlock>")
     ...
     * @Serializer\Type("AskerBundle\Model\Resources\ExerciseModel\GroupItems\ClassificationConstraints")
     * @Serializer\Groups({"details", "exercise_model_storage"})
     */
