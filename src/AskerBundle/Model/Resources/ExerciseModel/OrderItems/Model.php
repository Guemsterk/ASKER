...
namespace AskerBundle\Model\Resources\ExerciseModel\OrderItems;
...
class Model extends CommonModel
{
     ...
     * @Serializer\Type("AskerBundle\Model\Resources\ExerciseModel\OrderItems\SequenceBlock")
     ...
     * @Serializer\Type("array<AskerBundle\Model\Resources\ExerciseModel\OrderItems\ObjectBlock>")
     * @Serializer\Groups({"details", "exercise_model_storage"})
     */
