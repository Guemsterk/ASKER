...
class ExerciseModelResource extends SharedResource
{
    ...
    /**
     * @const MULTIPLE_CHOICE_MODEL_CLASS = 'AskerBundle\Model\Resources\ExerciseModel\MultipleChoice\Model'
     */
    const MULTIPLE_CHOICE_MODEL_CLASS = 'AskerBundle\Model\Resources\ExerciseModel\MultipleChoice\Model';

    /**
     * @const GROUP_ITEMS_MODEL_CLASS = 'AskerBundle\Model\Resources\ExerciseModel\GroupItems\Model'
     */
    const GROUP_ITEMS_MODEL_CLASS = 'AskerBundle\Model\Resources\ExerciseModel\GroupItems\Model';

    /**
     * @const ORDER_ITEMS_MODEL_CLASS = 'AskerBundle\Model\Resources\ExerciseModel\OrderItems\Model'
     */
    const ORDER_ITEMS_MODEL_CLASS = 'AskerBundle\Model\Resources\ExerciseModel\OrderItems\Model';

    /**
     * @const PAIR_ITEMS_MODEL_CLASS = 'AskerBundle\Model\Resources\ExerciseModel\PairItems\Model'
     */
    const PAIR_ITEMS_MODEL_CLASS = 'AskerBundle\Model\Resources\ExerciseModel\PairItems\Model';

    /**
     * @const OPEN_ENDED_QUESTION_CLASS = 'AskerBundle\Model\Resources\ExerciseModel\OpenEndedQuestion\Model'
     */
    const OPEN_ENDED_QUESTION_CLASS = 'AskerBundle\Model\Resources\ExerciseModel\OpenEndedQuestion\Model';
     ...
     * @Serializer\Type("AskerBundle\Model\Resources\ExerciseModel\Common\CommonModel")
     * @Assert\Valid
     */
    protected $content;
    ...
    /**
     * @var array
     * @Serializer\Type("array<AskerBundle\Model\Resources\ExerciseResource>")
     * @Serializer\Groups({"details"})
     */
    protected $exercises;
     ...
     * Set content
     *
     * @param \AskerBundle\Model\Resources\ExerciseModel\Common\CommonModel $content
     */
     ...
     * Get content
     *
     * @return \AskerBundle\Model\Resources\ExerciseModel\Common\CommonModel
     */
