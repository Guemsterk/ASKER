...
class ResourceResource extends SharedResource
{
    ...
    /**
     * @const MULTIPLE_CHOICE_QUESTION = 'AskerBundle\Model\Resources\ExerciseResource\MultipleChoiceQuestionResource'
     */
    const MULTIPLE_CHOICE_QUESTION_CLASS = 'AskerBundle\Model\Resources\ExerciseResource\MultipleChoiceQuestionResource';

    /**
     * @const PICTURE = 'AskerBundle\Model\Resources\ExerciseResource\PictureResource'
     */
    const PICTURE_CLASS = 'AskerBundle\Model\Resources\ExerciseResource\PictureResource';

    /**
     * @const SEQUENCE = 'AskerBundle\Model\Resources\ExerciseResource\SequenceResource'
     */
    const SEQUENCE_CLASS = 'AskerBundle\Model\Resources\ExerciseResource\SequenceResource';

    /**
     * @const OPEN_ENDED_QUESTION = 'AskerBundle\Model\Resources\ExerciseResource\OpenEndedQuestionResource'
     */
    const OPEN_ENDED_QUESTION_CLASS = 'AskerBundle\Model\Resources\ExerciseResource\OpenEndedQuestionResource';

    /**
     * @const TEXT = 'AskerBundle\Model\Resources\ExerciseResource\TextResource'
     */
    const TEXT_CLASS = 'AskerBundle\Model\Resources\ExerciseResource\TextResource';
     ...
     * @Serializer\Type("AskerBundle\Model\Resources\ExerciseResource\CommonResource")
    ...
    /**
     * @var array
     * @Serializer\Type("array<AskerBundle\Model\Resources\MetadataResource>")
     ...
     * Get content
     *
     * @return \AskerBundle\Model\Resources\ExerciseResource\CommonResource
     */
