...
use AskerBundle\Model\Resources\Exercise\Common\CommonItem;
...
class ItemResource
{
    ...
    /**
     * @const MULTIPLE_CHOICE_CLASS = 'AskerBundle\Model\Resources\Exercise\MultipleChoice\Question'
     */
    const MULTIPLE_CHOICE_CLASS = 'AskerBundle\Model\Resources\Exercise\MultipleChoice\Question';

    /**
     * @const OPEN_ENDED_QUESTION_CLASS ='AskerBundle\Model\Resources\Exercise\OpenEndedQuestion\Question'
     */
    const OPEN_ENDED_QUESTION_CLASS = 'AskerBundle\Model\Resources\Exercise\OpenEndedQuestion\Question';

    /**
     * @const GROUP_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\GroupItems\Item'
     */
    const GROUP_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\GroupItems\Item';
     ...
     * @const GROUP_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\GroupItems\Item'
     */
    const ORDER_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\OrderItems\Item';

    /**
     * @const PAIR_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\PairItems\Item'
     */
    const PAIR_ITEMS_CLASS = 'AskerBundle\Model\Resources\Exercise\PairItems\Item';
     ...
     * @Serializer\Type("AskerBundle\Model\Resources\Exercise\Common\CommonItem")
     ...
     * Set content
     *
     * @param \AskerBundle\Model\Resources\Exercise\Common\CommonItem $content
     */
     ...
     * Get content
     *
     * @return \AskerBundle\Model\Resources\Exercise\Common\CommonItem
     */
