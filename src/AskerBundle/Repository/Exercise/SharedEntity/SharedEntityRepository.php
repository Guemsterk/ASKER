...
namespace AskerBundle\Repository\Exercise\SharedEntity;

use AppBundle\Entity\User;
use Doctrine\DBAL\DBALException;
use Doctrine\ORM\QueryBuilder;
use AskerBundle\Entity\SharedEntity\SharedEntity;
use AskerBundle\Exception\EntityAlreadyExistsException;
...
abstract class SharedEntityRepository extends BaseRepository
{
     ...
     *
     * @throws \AskerBundle\Exception\FilterException
     * @return array
     */
     ...
     *
     * @throws \AskerBundle\Exception\EntityAlreadyExistsException
     */
