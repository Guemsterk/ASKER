...
namespace AskerBundle\ParamConverter;

use Sensio\Bundle\FrameworkExtraBundle\Configuration\ParamConverter;
use Sensio\Bundle\FrameworkExtraBundle\Request\ParamConverter\ParamConverterInterface;
use AskerBundle\Exception\Api\ApiException;
use AskerBundle\Model\Collection\CollectionInformation;
use AskerBundle\Model\Collection\Sort;
...
class ApiCollectionParamConverter implements ParamConverterInterface
{
     ...
     *
     * @throws \AskerBundle\Exception\Api\ApiException
     * @return bool
     */
    ...
    )
    {
        ...
        if ('AskerBundle\Model\Collection\CollectionInformation' ===
            $configuration->getClass()
        ) {
            $isClassSupported = true;
        }
		/*
		if($isClassSupported == false) {
			throw new \LogicException('Error Localisation' + $configuration->getClass());
		}
		*/
