...
namespace AskerBundle\Service\Exercise\ExerciseResource;

use AppBundle\Entity\User;
use Doctrine\Common\Collections\ArrayCollection;
use AskerBundle\Entity\DomainKnowledge\Knowledge;
use AskerBundle\Entity\ExerciseResource\ExerciseResource;
use AskerBundle\Entity\ExerciseResource\Metadata;
use AskerBundle\Entity\ExerciseResourceFactory;
use AskerBundle\Exception\Api\ApiNotFoundException;
use AskerBundle\Exception\InconsistentEntityException;
use AskerBundle\Exception\InvalidExerciseResourceException;
use AskerBundle\Exception\InvalidTypeException;
use AskerBundle\Exception\NonExistingObjectException;
use AskerBundle\Model\ExerciseObject\ExerciseObjectFactory;
use AskerBundle\Model\Resources\DomainKnowledge\Formula\LocalFormula;
use AskerBundle\Model\Resources\ExerciseObject\ExerciseObject;
use AskerBundle\Model\Resources\ExerciseResource\CommonResource;
use AskerBundle\Model\Resources\ExerciseResource\MultipleChoice\MultipleChoicePropositionResource;
use AskerBundle\Model\Resources\ExerciseResource\MultipleChoiceQuestionResource;
use AskerBundle\Model\Resources\ExerciseResource\OpenEndedQuestionResource;
use AskerBundle\Model\Resources\ExerciseResource\PictureResource;
use AskerBundle\Model\Resources\ExerciseResource\Sequence\ResourceId;
use AskerBundle\Model\Resources\ExerciseResource\Sequence\SequenceBlock;
use AskerBundle\Model\Resources\ExerciseResource\Sequence\SequenceElement;
use AskerBundle\Model\Resources\ExerciseResource\SequenceResource;
use AskerBundle\Model\Resources\ExerciseResource\TextResource;
...
use AskerBundle\Model\Resources\ResourceResourceFactory;
use AskerBundle\Repository\Exercise\ExerciseResource\ExerciseResourceRepository;
...
class ExerciseResourceService extends SharedEntityService implements ExerciseResourceServiceInterface
{
     ...
     *
     * @throws \AskerBundle\Exception\InvalidExerciseResourceException
     ...
     * @internal param \AskerBundle\Model\Resources\ResourceResource $resource
