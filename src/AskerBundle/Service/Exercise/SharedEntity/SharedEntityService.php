...
namespace AskerBundle\Service\Exercise\SharedEntity;
...
use AskerBundle\Model\Resources\SharedResource;
use AskerBundle\Model\Resources\SharedResourceFactory;
use AskerBundle\Repository\Exercise\SharedEntity\SharedEntityRepository;
use AskerBundle\Service\Serializer\SerializerInterface;
...
abstract class SharedEntityService extends TransactionalService implements SharedEntityServiceInterface
{
     ...
     *
     * @throws \AskerBundle\Exception\NoAuthorException
     * @return SharedEntity
     */
    ...
    )
    {
		...
		//$entity->setAuthor($sharedResource->getAuthor());
        $entity->setAuthor(
     ...
     * @param              $content
     *
     * @internal param \AskerBundle\Model\Resources\SharedResource $resource
    ...
    public function subscribe($ownerId, $parentEntityId)
    {
        ...
        if (get_class(
                $entity
            ) === 'AskerBundle\Entity\ExerciseModel\ExerciseModel'
        ) {
