...
use AskerBundle\Entity\AnswerFactory;
...
use AskerBundle\Service\Exercise\ExerciseCreation\ExerciseService;
...
class AnswerService extends TransactionalService implements AnswerServiceInterface
{
     ...
     * @param int            $userId
     *
     * @throws \AskerBundle\Exception\AnswerAlreadyExistsException
     * @return ItemResource
     */
