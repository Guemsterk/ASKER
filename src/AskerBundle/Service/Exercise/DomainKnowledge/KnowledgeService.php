...
use AskerBundle\Entity\KnowledgeFactory;
...
use AskerBundle\Model\Resources\DomainKnowledge\CommonKnowledge;
...
use AskerBundle\Repository\Exercise\DomainKnowledge\KnowledgeRepository;
...
class KnowledgeService extends SharedEntityService implements KnowledgeServiceInterface
{
     ...
     * Set formulaService
     *
     * @param \AskerBundle\Service\Exercise\DomainKnowledge\FormulaServiceInterface $formulaService
     */
     ...
     * @internal param \AskerBundle\Model\Resources\KnowledgeResource $resource
