...
namespace AskerBundle\Service\Exercise\ExerciseModel;

//use AppBundle\Entity\Resource\ResourceNode;
use AppBundle\Entity\User;
use AppBundle\Manager\ResourceManager;
//use AppBundle\Repository\ResourceNodeRepository;
...
use AskerBundle\Entity\ExerciseModel\Metadata;
use AskerBundle\Entity\ExerciseModelFactory;
use AskerBundle\Entity\ExerciseResource\ExerciseResource;
use AskerBundle\Exception\InconsistentEntityException;
...
use AskerBundle\Model\Resources\DomainKnowledge\Formula\LocalFormula;
...
use AskerBundle\Model\Resources\ExerciseModel\Common\ResourceBlock;
use AskerBundle\Model\Resources\ExerciseModel\GroupItems\ClassificationConstraints;
use AskerBundle\Model\Resources\ExerciseModel\GroupItems\Group;
use AskerBundle\Model\Resources\ExerciseModel\GroupItems\Model as GroupItems;
use AskerBundle\Model\Resources\ExerciseModel\GroupItems\ObjectBlock as GIObjectBlock;
use AskerBundle\Model\Resources\ExerciseModel\MultipleChoice\Model as MultipleChoice;
use AskerBundle\Model\Resources\ExerciseModel\MultipleChoice\QuestionBlock as MCQuestionBlock;
use AskerBundle\Model\Resources\ExerciseModel\OpenEndedQuestion\Model as OpenEnded;
use AskerBundle\Model\Resources\ExerciseModel\OpenEndedQuestion\QuestionBlock as OEQuestionBlock;
use AskerBundle\Model\Resources\ExerciseModel\OrderItems\Model as OrderItems;
use AskerBundle\Model\Resources\ExerciseModel\OrderItems\ObjectBlock as OIObjectBlock;
use AskerBundle\Model\Resources\ExerciseModel\PairItems\Model as PairItems;
use AskerBundle\Model\Resources\ExerciseModel\PairItems\PairBlock;
use AskerBundle\Model\Resources\ExerciseModelResource;
use AskerBundle\Model\Resources\ExerciseModelResourceFactory;
use AskerBundle\Model\Resources\ExerciseResource\CommonResource;
use AskerBundle\Model\Resources\KnowledgeResource;
use AskerBundle\Model\Resources\ModelObject\MetadataConstraint;
use AskerBundle\Model\Resources\ModelObject\ModelDocument;
use AskerBundle\Model\Resources\ModelObject\ObjectConstraints;
use AskerBundle\Model\Resources\ModelObject\ObjectId;
use AskerBundle\Model\Resources\ResourceResource;
use AskerBundle\Repository\Exercise\ExerciseModel\ExerciseModelRepository;
use AskerBundle\Service\Exercise\DomainKnowledge\KnowledgeServiceInterface;
use AskerBundle\Service\Exercise\ExerciseResource\ExerciseResourceServiceInterface;
use AskerBundle\Service\Exercise\SharedEntity\SharedEntityService;
...
class ExerciseModelService extends SharedEntityService implements ExerciseModelServiceInterface
{
     ...
     *
     * @param \AskerBundle\Service\Exercise\DomainKnowledge\KnowledgeServiceInterface $knowledgeService
     */
     ...
     * Set resourceManager
     *
     * @param \AppBundle\Manager\ResourceManager $resourceManager
     */
     ...
     *
     * @param \AppBundle\Repository\ResourceNodeRepository $resourceNodeRepository
     */
	 /*
     ...
     * @param               $content
     *
     * @throws \AskerBundle\Exception\InconsistentEntityException
     ...
     * @param $type
     *
     * @throws \AskerBundle\Exception\InvalidTypeException
     */
