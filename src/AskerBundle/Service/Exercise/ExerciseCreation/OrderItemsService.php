...
use AskerBundle\Model\Resources\Exercise\OrderItems\Exercise;
use AskerBundle\Model\Resources\Exercise\OrderItems\Item as ResItem;
use AskerBundle\Model\Resources\ExerciseModel\Common\CommonModel;
use AskerBundle\Model\Resources\ExerciseModel\OrderItems\Model;
use AskerBundle\Model\Resources\ExerciseModel\OrderItems\ObjectBlock;
use AskerBundle\Model\Resources\ExerciseModel\OrderItems\SequenceBlock;
use AskerBundle\Model\Resources\ExerciseObject\ExerciseObject;
use AskerBundle\Model\Resources\ExerciseObject\ExerciseSequenceObject;
...
class OrderItemsService extends ExerciseCreationService
{
    ...
    private function mergeObj(ExerciseTextObject $obj1, ExerciseTextObject $obj2)
    {
        if (
            get_class(
                $obj1
            ) === 'AskerBundle\Model\Resources\ExerciseObject\ExerciseTextObject' &&
            get_class(
                $obj2
            ) === 'AskerBundle\Model\Resources\ExerciseObject\ExerciseTextObject'
        ) {
    ...
    {
        /** @var \AskerBundle\Model\Resources\Exercise\OrderItems\Item $content */
