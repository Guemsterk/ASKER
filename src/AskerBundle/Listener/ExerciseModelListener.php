...
namespace AskerBundle\Listener;

use AppBundle\Event\CopyResourceEvent;
use AppBundle\Event\CreateFormResourceEvent;
use AppBundle\Event\CustomActionResourceEvent;
use AppBundle\Event\DeleteResourceEvent;
use AppBundle\Event\OpenResourceEvent;
...
class ExerciseModelListener implements ContainerAwareInterface
{
    ...
    public function onDelete(DeleteResourceEvent $event)
    {
        ...
        $exerciseModel = $this->container->get('asker.exercise.exercise_model')->get(
    ...
    public function onCopy(CopyResourceEvent $event)
    {
        ...
        $copy = $this->container->get('asker.exercise.exercise_model')->duplicate(
            $original->getId(),
            $this->container->get('security.authorization_checker')->getToken()->getUser()->getId()
        );
